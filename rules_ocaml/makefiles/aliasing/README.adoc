...
a. a definition of B embedded in A;
b. an equation, in A, aliasing B to some other module

In case b, it will search the text of A preceding the equation for a
