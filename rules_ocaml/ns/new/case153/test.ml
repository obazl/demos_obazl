...
let test7 test_ctxt = assert_equal 255 (Color.Greek.Foobar.Foo.v)
let test8 test_ctxt = assert_equal 127 (Color.Greek.Foobar.Bar.v)
let test9 test_ctxt = assert_equal 80  (Color.Greek.Foobar.Baz.v)
